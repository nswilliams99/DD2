...
const OrganizationSchema = () => {
  const organizationSchema = {
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Residential Trash Collection", "description": "Weekly curbside trash and recycling pickup for homes" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Commercial Dumpster Service", "description": "2-3 yard commercial dumpsters with flexible pickup schedules" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Roll-Off Container Rental", "description": "10-40 yard roll-off dumpsters for construction and large projects" } }
      ]
    },
