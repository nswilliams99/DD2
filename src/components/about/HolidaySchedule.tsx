        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <div className="bg-[#53565A] text-[#D11768] font-bold text-4xl lg:text-5xl py-10 px-8 rounded-xl mb-8 mx-auto max-w-2xl">
                Holiday = 1 Day Later
              </div>
              <div className="flex flex-wrap justify-center gap-8 mb-12">
                ...
                <div className="flex flex-col items-center text-center">
                  <img src="/lovable-uploads/e6f3e6a8-d84a-413d-893c-7f0aa8e128bb.png" alt="Turkey icon for Thanksgiving" className="w-12 h-12 mb-2 object-contain" />
              ...
              <h2 id="holiday-schedule-heading" className="text-4xl lg:text-5xl font-bold text-foreground mb-6">Dumpster Diverz Holiday Observance</h2>
              <div className="text-lg text-black leading-relaxed mb-8 max-w-3xl mx-auto">
                <p className="mb-6">
                  Dumpster Diverz observes six major U.S. holidays each year: <span className="underline" style={{textDecorationColor: '#D11768'}}>New Year's Day, Memorial Day, Independence Day, Labor Day, Thanksgiving Day, and Christmas Day</span>. These holidays may affect your regular trash pickup schedule, but our goal is to keep your service consistent and predictable.
                </p>
              </div>
            </div>
            <div className="bg-background rounded-2xl p-8 shadow-sm border border-border mb-12">
              ...
              <div className="text-lg text-black leading-relaxed mb-8">
                <p className="mb-6">
                  If a holiday falls on or before your normal pickup day, <span className="underline font-semibold" style={{textDecorationColor: '#D11768'}}>your trash collection will be moved back by one day</span> for the remainder of that week. For example, if a holiday is on Monday, Monday routes will run Tuesday, Tuesday routes will run Wednesday, and so on. <span className="underline font-semibold" style={{textDecorationColor: '#D11768'}}>When a holiday lands on Friday, your pickup will shift to Saturday of the same week</span>.
                </p>
              </div>
            </div>
            <div className="mb-16">
              ...
              <Accordion type="single" collapsible className="w-full space-y-4" role="region" aria-label="Holiday FAQ accordion">
                {holidayFAQs.map((faq, index) => (
                  <AccordionItem key={index} value={`holiday-item-${index}`} className="bg-background rounded-lg border border-border px-6">
