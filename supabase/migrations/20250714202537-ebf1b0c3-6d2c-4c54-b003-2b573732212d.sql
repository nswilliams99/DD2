-- Create improved email notification system with comprehensive logging and error handling
...
CREATE TABLE IF NOT EXISTS email_attempts (
  ...
  CONSTRAINT fk_email_attempts_quote_id FOREIGN KEY (quote_id) REFERENCES quote_requests(id)
);
...
BEGIN
  ...
  VALUES ('00000000-0000-0000-0000-000000000000', 0, 'connectivity_test', 
...
EXCEPTION WHEN OTHERS THEN
  -- Log the error
  INSERT INTO email_attempts (quote_id, attempt_number, status, error_message, attempted_at)
  VALUES ('00000000-0000-0000-0000-000000000000', 0, 'connectivity_failed', 
