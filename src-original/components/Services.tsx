              ...
              <CardContent className="p-0 h-full flex flex-col">
                 ...
                 <div className="h-1/2 flex-1 justify-center items-center flex flex-col p-4">
                   ...
                   <Button 
                     ...
                     asChild
                   >
                     <Link to="/residential" aria-label="Learn more about residential trash pickup services">
                       Learn More
              ...
              <CardContent className="p-0 h-full flex flex-col">
                 ...
                 <div className="h-1/2 flex-1 justify-center items-center flex flex-col p-4">
                   ...
                   <Button 
                     ...
                     asChild
                   >
                     <Link to="/commercial" aria-label="Learn more about commercial dumpster rental services">
                       Learn More
                       <ArrowRight className="ml-2 h-3 w-3 group-hover/btn:translate-x-1 transition-transform duration-300" aria-hidden="true" />
                     </Link>
                   </Button>
              ...
              <CardContent className="p-0 h-full flex flex-col">
                ...
                <div className="h-1/2 flex-1 justify-center items-center flex flex-col p-4">
                  ...
                  <Button 
                    ...
                    asChild
                  >
                    <Link to="/roll-off-dumpsters" aria-label="Learn more about roll-off dumpster rental services">
                      Learn More
                      <ArrowRight className="ml-2 h-3 w-3 group-hover/btn:translate-x-1 transition-transform duration-300" aria-hidden="true" />
                    </Link>
                  </Button>
